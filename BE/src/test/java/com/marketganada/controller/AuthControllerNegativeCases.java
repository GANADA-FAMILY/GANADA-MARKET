...
public class AuthControllerNegativeCases {
    ...
    void signupFailTest() throws Exception {
        ...
        input2.put("userPhone", "010-1234-1234");
        mockMvc.perform(MockMvcRequestBuilders.post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        input3.put("userPhone", "010-1234-1234");
        mockMvc.perform(MockMvcRequestBuilders.post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        input5.put("userEmail", "test@ssafy.com"); // 중복 이메일
        input5.put("userPw", "test123!@#");
        input5.put("userNickname", "테스트유저2");
        input5.put("userPhone", "010-1234-1234");
        mockMvc.perform(MockMvcRequestBuilders.post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        input6.put("userPhone", "010-1234-1234");
        mockMvc.perform(MockMvcRequestBuilders.post("/api/auth/signup")
                        .contentType(MediaType.APPLICATION_JSON)
